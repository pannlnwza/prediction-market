...
export default function MarketCard({ market }: { market: Market }) {
  ...
  return (
    <div className="border border-gray-200 rounded-xl bg-white hover:shadow-sm transition-shadow flex flex-col">
      {/* Title */}
      <div className="p-4 pb-3">
        <Link to={`/market/${market.id}`} className="no-underline hover:underline">
      ...
      <div className="px-4 py-2 mt-1 flex items-center justify-between">
        ...
        <button
          ...
          className="text-gray-500 hover:text-gray-600 bg-transparent border-none cursor-pointer transition-colors"
        >
